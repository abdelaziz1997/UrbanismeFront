	...
	data: {
		...
		AUTH: {
			...
			VALIDATION: {
				...
				MIN_LENGTH: '{{name}} minimum longueur est {{min}}',
				AGREEMENT_REQUIRED: 'Accepting terms & conditions are required',
				NOT_FOUND: 'Le {{name}} requis n\'est pas trouvé',
				INVALID_LOGIN: 'Email ou Mot de passe est incorrect',
				REQUIRED_FIELD: 'Champs requis',
				MIN_LENGTH_FIELD: 'Minimum field length:',
				MAX_LENGTH_FIELD: 'Maximum field length:',
				INVALID_FIELD: 'Champs n\'est pas valide',
			}
		},
		ECOMMERCE: {
			COMMON: {
